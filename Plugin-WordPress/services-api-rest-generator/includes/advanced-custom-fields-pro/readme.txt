...
* Users (select 1 or more WP users, api returns the selected user objects)
...
= 5.3.5 =
* Users field: Fixed pagination bug causing missing results
...
= 5.3.4 =
* Users field: Added pagination for Select2 results
...
* Users field: Added new filters 'acf/fields/user/result' and 'acf/fields/user/search_columns'
...
* Field group: Added new location rule 'Current Users'
* Field group: Renamed location rule 'Logged in Users Type' to 'Current Users Role'
...
* Users field: Fixed PHP error preventing choices from being loaded
...
* [Added] Users field: Add sanitisation into update_value function to allow for array / object with ID attribute
